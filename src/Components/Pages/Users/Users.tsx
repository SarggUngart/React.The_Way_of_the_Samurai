...
import userPhoto from '../../../assets/immages/default_user_img.png'
      ...
      <div className={styles.wrapper}>
        {users.map(u =>
          <div className={styles.users} key={u.id}>
            <div className={styles.avatarWrapper}><img src={u.photos.small || userPhoto} className={styles.avatar} alt="user_photo"/>
            </div>
